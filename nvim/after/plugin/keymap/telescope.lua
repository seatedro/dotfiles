...
nnoremap("<leader>vrc", function()
    require('rpc.telescope').search_dotfiles({ hidden = true })
end)
nnoremap("<leader>va", function()
    require('rpc.telescope').anime_selector()
end)
nnoremap("<leader>vc", function()
    require('rpc.telescope').chat_selector()
end)
nnoremap("<leader>gc", function()
    require('rpc.telescope').git_branches()
end)
